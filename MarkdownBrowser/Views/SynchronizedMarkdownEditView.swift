...
struct SynchronizedMarkdownEditView: View {
    let fileURL: URL
    @Environment(\.dismiss) private var dismiss
    @StateObject private var viewModel = MarkdownViewModel()
    @StateObject private var scrollSynchronizer = ScrollSynchronizer()
    @State private var editingContent: String = ""
    @State private var layoutMode: LayoutMode = .sideBySide
    @State private var isLoading = true
    @State private var editorScrollPercentage: Double = 0
    @State private var previewScrollPercentage: Double = 0
    ...
    var body: some View {
                        ...
                        VStack(spacing: 0) {
                            ...
                            SynchronizedTextEditor(
                                ...
                                onScrollChange: { percentage in
                                    previewScrollPercentage = percentage
                                }
                            )
                        }
                        .frame(minWidth: 300)
                        ...
                        VStack(spacing: 0) {
                            ...
                            if isLoading {
                                ...
                                SynchronizedPreviewView(
                                    ...
                                    scrollSynchronizer: scrollSynchronizer,
                                    onScrollChange: { percentage in
                                        editorScrollPercentage = percentage
                                    },
        ...
        .onChange(of: editorScrollPercentage) { newValue in
            previewScrollPercentage = newValue
        }
        .onChange(of: previewScrollPercentage) { newValue in
            editorScrollPercentage = newValue
        }
    }
